...
// ResultReg returns the result register assigned to v, in github.com/ryan-berger/golang_tv/internal/src/cmd/internal/obj/$ARCH numbering.
...
// Reg returns the register assigned to v, in github.com/ryan-berger/golang_tv/internal/src/cmd/internal/obj/$ARCH numbering.
...
// Reg0 returns the register assigned to the first output of v, in github.com/ryan-berger/golang_tv/internal/src/cmd/internal/obj/$ARCH numbering.
...
// Reg1 returns the register assigned to the second output of v, in github.com/ryan-berger/golang_tv/internal/src/cmd/internal/obj/$ARCH numbering.
...
// RegTmp returns the temporary register assigned to v, in github.com/ryan-berger/golang_tv/internal/src/cmd/internal/obj/$ARCH numbering.

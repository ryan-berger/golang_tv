...
type Register struct {
	...
	objNum int16 // register number from github.com/ryan-berger/golang_tv/internal/src/cmd/internal/obj/$ARCH
...
// ObjNum returns the register number from github.com/ryan-berger/golang_tv/internal/src/cmd/internal/obj/$ARCH that

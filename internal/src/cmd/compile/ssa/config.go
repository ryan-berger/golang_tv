...
type Config struct {
	...
	PtrSize        int64  // 4 or 8; copy of github.com/ryan-berger/golang_tv/internal/src/cmd/internal/sys.Arch.PtrSize
	RegSize        int64  // 4 or 8; copy of github.com/ryan-berger/golang_tv/internal/src/cmd/internal/sys.Arch.RegSize
	Types          Types

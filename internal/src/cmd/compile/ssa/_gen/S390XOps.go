...
func init() {
	...
	archs = append(archs, arch{
		name:            "S390X",
		pkg:             "github.com/ryan-berger/golang_tv/internal/src/cmd/internal_compile/obj/s390x",
		...
		imports: []string{
			"github.com/ryan-berger/golang_tv/internal/src/cmd/internal_compile/obj/s390x",
		},
	})
}

...
import (
	...
	"github.com/ryan-berger/golang_tv/internal/src/cmd/compile/types2"
	"github.com/ryan-berger/golang_tv/internal/src/internal/pkgbits"
	"go/token"
	"sync"
)
...
const deltaNewFile = -64 // see github.com/ryan-berger/golang_tv/internal/src/cmd/compile/gc/bexport.go
...
func chanDir(d int) types2.ChanDir {
	// tag values must match the constants in github.com/ryan-berger/golang_tv/internal/src/cmd/compile/gc/go.go
	switch d {
	case 1 /* Crecv */ :
...
// See github.com/ryan-berger/golang_tv/internal/src/cmd/compile/noder.derivedInfo.
type derivedInfo struct {
	idx    pkgbits.Index
	needed bool
}

// See github.com/ryan-berger/golang_tv/internal/src/cmd/compile/noder.typeInfo.

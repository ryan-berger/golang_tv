...
func main() {
	...
	fmt.Fprintln(&b, `      "github.com/ryan-berger/golang_tv/internal/src/cmd/compile/types"`)
	fmt.Fprintln(&b, `      "github.com/ryan-berger/golang_tv/internal/src/cmd/internal/src"`)
	fmt.Fprintln(&b, `)`)
